    ...
    <Document>
      ...
      <Text style={styles.header} fixed>
        ...
        <Text style={styles.text}>
            ...
            {"\n"}
            <Text>
            Order Id: { order.paymentIntent.id }</Text>
            <Text>
            {"\n"}
                Order Status: { order.orderStatus }</Text>
            <Text>
            {"\n"}
                Total Paid: { order.paymentIntent.amount }</Text>
            {"\n"}
        </Text>

        <Text style={styles.footer}>~ Thanks for shopping 4 us! ~ </Text>
      </Page>
    </Document>
  );
};
